...
void setup() {
    ...
    Serial.println("Cek dan Tambah Saldo");
...
void loop() {
  ...
  if (notif){
    ...
    Serial.println("contoh input 1000");
    Serial.println();
    Serial.println("JIKA INGIN CEK SALDO LANGSUNG TAP");
  }
  ...
  if (isiSaldo){
    ...
    if (digit > 255){
      saldo = 0;
      digit = 0;
      Serial.println("Saldo melewati limit sebesar 255.000");
